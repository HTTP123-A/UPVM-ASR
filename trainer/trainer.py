...
class Trainer(BaseTrainer):
        ...
        with logging_redirect_tqdm(loggers=[self.logger], tqdm_class=tqdm):
            with tqdm(
                ...
                for batch_idx, (
                    ...
                    highcut = highcut.to(self.device, non_blocking=True)

                    # print("wave_input:", wave_input.device)
                    # print("highcut:", highcut.device)
                    # print("target:", wave_target.device)
    ...
    def _optimize_adversarial(self, loss):
        ...
        if self.amp and self.scaler_D is not None:
