...
class BaseTester:
    ...
    def _resume_checkpoint(self):
        ...
        """
        self.models, _, self.config, _, self.is_quantized = load_from_path(
    ...
    def _log_results(self, results):
        ...
        # sort keys by our order, everything unknown goes to the end
        def sort_key(k):
            return desired_order.index(k) if k in desired_order else len(desired_order)
